      ...
      <div className="relative z-10 max-w-6xl mx-auto px-5 py-16">
        ...
        <div className="text-center space-y-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 max-w-md mx-auto border border-green-400/20 hover:bg-white/15 transition-all duration-300 group">
            ...
            <a 
              href="mailto:arfat1islam5162@gmail.com" 
          ...
          {/* Social Media Icons */}
          <div className="space-y-4">
            <p className="text-lg text-green-100 font-medium">Connect with me</p>
              ...
              {socialLinks.map((social, index) => (
                <a
                  ...
                  style={{ 
                    ...
                    boxShadow: hoveredIcon === index ? '0 20px 40px rgba(0,0,0,0.3)' : '0 5px 15px rgba(0,0,0,0.1)'
                  }}
                >
                  <img 
                    src={social.icon} 
