                ...
                <div className="max-w-6xl w-full bg-gradient-to-r from-green-400 via-green-200 to-green-100 rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden transform transition duration-500 hover:scale-105">
                    ...
                    <div className="md:w-2/3 bg-white p-12 md:p-16 relative">
                        ...
                        <p className="text-gray-600 leading-relaxed mb-5 font-lora text-lg">
                            I thrive on crafting scalable, high-performance, and user-centric web applications. From pixel-perfect frontend designs to robust backend architectures, I turn ideas into seamless digital experiences.
                        </p>
                        <p className="text-gray-600 leading-relaxed mb-6 font-lora text-lg">
                            💡 Passionate about clean and efficient code. My goal? To bridge innovation with functionality—creating web solutions that are both intuitive and powerful.
                        </p>
                        ...
                        <div className="mt-6">
                            ...
                            <div className="flex items-center gap-5 mt-4">
                                <a href="#" className="text-green-600 hover:text-green-800 text-2xl transition duration-300">
