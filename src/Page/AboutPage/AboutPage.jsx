  ...
  const journeySteps = [
    {
      icon: '💡',
      title: 'My Journey',
      description: 'I started learning web development with HTML, CSS, and JavaScript. As I grew confident, I embraced React and modern UI libraries to create better experiences.',
      color: 'from-blue-400 to-blue-600'
    },
    {
      icon: '⚛️',
      title: 'React & Tailwind',
      description: 'I build responsive, modular user interfaces using React.js and style them beautifully with Tailwind CSS. I understand DOM manipulation, props, state, and use hooks like useState, useEffect, and React Router effectively.',
      color: 'from-purple-400 to-purple-600'
    },
    {
      icon: '🛠️',
      title: 'Projects',
      description: 'I\'ve built projects like a Quiz Website, a Car Selling Platform, and a Punjabi E-commerce Store — always focusing on clean code and smooth user experience.',
      color: 'from-orange-400 to-orange-600'
    },
    {
      icon: '🤝',
      title: 'Collaboration & Vision',
      description: 'I\'m comfortable using Git & GitHub, love teamwork, and aim to work on impactful real-world projects while constantly learning new technologies.',
  ...
  const highlights = [
    {
      ...
      description: 'I have primarily learned through online platforms and make it a habit to learn something new every day. I\'m always curious to explore and apply new technologies and tools.',
      gradient: 'from-pink-400 to-red-500'
    },
    {
      icon: '⏰',
      title: 'Time Management',
      description: 'I always try to finish tasks on time and stick to deadlines. I consider time management a key part of every project I handle.',
      gradient: 'from-yellow-400 to-orange-500'
    },
    {
      icon: '🧰',
      title: 'Tools & Software',
      description: 'I use Visual Studio Code for coding, GitHub for version control, and can convert UI designs from Figma to functional code.',
      gradient: 'from-blue-400 to-indigo-500'
    },
    {
      icon: '📣',
      title: 'User Feedback',
      description: 'I have shared some of my projects with friends and mentors who appreciated the UI and overall design experience.',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100 relative overflow-hidden">
      ...
      <div className="relative z-10 py-20 px-4 md:px-10">
        {/* Hero Section */}
        <div className={`max-w-5xl mx-auto text-center mb-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
            I'm <span className="text-green-600">Ariful Islam</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            A passionate <span className="font-semibold text-green-600">Frontend Developer</span> focused on building modern web apps with React.js and Tailwind CSS.
          </p>
        ...
        <div className="max-w-6xl mx-auto mb-20">
          <h3 className="text-3xl font-bold text-center text-gray-800 mb-12">
            <span className="bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">My Development Journey</span>
          </h3>
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {journeySteps.map((step, index) => (
                <div key={index} className={`relative flex items-start transition-all duration-700 delay-${index * 200} ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                  {/* Timeline Node */}
                  <div className={`relative z-10 w-16 h-16 bg-gradient-to-r ${step.color} rounded-full flex items-center justify-center text-2xl shadow-lg hover:scale-110 transition-transform duration-300`}>
                    {step.icon}
                  </div>
                  ...
                  <div className="ml-8 flex-1 bg-white rounded-2xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
                    <div className={`absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b ${step.color} rounded-l-2xl`}></div>
        ...
        <div className="max-w-6xl mx-auto mb-20">
          <h3 className="text-3xl font-bold text-center text-gray-800 mb-12">
            <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">✨ Professional Highlights</span>
          </h3>
          
          <div className="grid md:grid-cols-2 gap-8">
            {highlights.map((highlight, index) => (
              <div key={index} className={`group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-gray-200 transform hover:-translate-y-2 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: `${index * 100}ms` }}>
                <div className={`w-16 h-16 bg-gradient-to-r ${highlight.gradient} rounded-2xl flex items-center justify-center text-2xl mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                  {highlight.icon}
                </div>
        ...
        <div className="max-w-6xl mx-auto mb-20">
          <h3 className="text-3xl font-bold text-center text-gray-800 mb-12">
            <span className="bg-gradient-to-r from-green-600 to-purple-600 bg-clip-text text-transparent">💼 Technical Skills</span>
          </h3>
          ...
          <div className="bg-gradient-to-r from-green-500 to-blue-600 rounded-3xl p-8 shadow-2xl text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg md:text-xl opacity-90 mb-6">
                I'm excited to work on meaningful projects. Let's connect and create something extraordinary together!
              </p>
